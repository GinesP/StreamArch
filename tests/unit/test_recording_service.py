...
class TestStartRecording:
    ...
    def test_starts_ffmpeg_runner(
        ...
        assert kwargs["output_path"] == file_manager.allocate_path.return_value.as_posix()
    ...
    def test_ignores_cookie_service_for_ffmpeg_start(
        self,
        runner: MagicMock,
        file_manager: MagicMock,
        session_repo: MagicMock,
        ...
        """Recording uses the resolved stream URL directly, not resolver cookies."""
        cookie_service = MagicMock()
        cookie_service.get_cookie_string.return_value = "sessionid=abc123; csrftoken=xyz"
        ...
        assert runner.start_recording.call_args.kwargs["headers"] is None
